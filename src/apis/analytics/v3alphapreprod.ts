...
export namespace analytics_v3alphapreprod {
  ...
  /**
   * Google Analytics API - Alpha Version
   *
   * Views and manages your Google Analytics data.
   *
   * @example
   * const {google} = require('googleapis');
   * const analytics = google.analytics('v3alphapreprod');
   *
   * @namespace analytics
   * @type {Function}
   * @version v3alphapreprod
   * @variation v3alphapreprod
  ...
  export interface Schema$UserDeletionRequestKey {
    /**
     * Firebase Project Id
     */
    firebaseProjectId?: string | null;
    ...
    id?: {type?: string; userId?: string} | null;
    /**
     * Value is &quot;analytics#userDeletionRequestKey&quot;.
     */
    kind?: string | null;
    /**
     * Web property ID of the form UA-XXXXX-YY.
  ...
  export class Resource$Data$Ga {
     ...
     *     // A comma-separated list of Analytics metrics. E.g., 'ga:sessions,ga:pageviews'. 'ga:sessions' is the default if no metric is specified.
     *     metrics: 'ga:.+',
     ...
     * @param {string=} params.metrics A comma-separated list of Analytics metrics. E.g., 'ga:sessions,ga:pageviews'. 'ga:sessions' is the default if no metric is specified.
     ...
     * @param {string=} params.segment An Analytics advanced segment to be applied to data.
    ...
    get(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/analytics/v3alphapreprod/data/ga').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Data$Mcf {
     ...
     *     // The maximum number of entries to include in this feed.
     *     'max-results': 'placeholder-value',
     *     // A comma-separated list of Multi-Channel Funnels metrics. E.g., 'mcf:totalConversions,mcf:totalConversionValue'. 'mcf:totalConversions' is the default if no metric is specified.
     *     metrics: 'mcf:.+',
     *     // The desired sampling level.
     *     samplingLevel: 'placeholder-value',
     ...
     * @param {string} params.ids Unique table ID for retrieving Analytics data. Table ID is of the form ga:XXXX, where XXXX is the Analytics view (profile) ID.
     * @param {integer=} params.max-results The maximum number of entries to include in this feed.
     * @param {string=} params.metrics A comma-separated list of Multi-Channel Funnels metrics. E.g., 'mcf:totalConversions,mcf:totalConversionValue'. 'mcf:totalConversions' is the default if no metric is specified.
     * @param {string=} params.samplingLevel The desired sampling level.
    ...
    get(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/analytics/v3alphapreprod/data/mcf').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Data$Realtime {
     ...
     *     // The maximum number of entries to include in this feed.
     *     'max-results': 'placeholder-value',
     *     // A comma-separated list of real time metrics. E.g., 'rt:activeUsers'. 'rt:activeUsers' is the default if no metric is specified.
     *     metrics: '(ga:.+)|(rt:.+)',
     ...
     * @param {integer=} params.max-results The maximum number of entries to include in this feed.
     * @param {string=} params.metrics A comma-separated list of real time metrics. E.g., 'rt:activeUsers'. 'rt:activeUsers' is the default if no metric is specified.
    ...
    get(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/analytics/v3alphapreprod/data/realtime').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/analytics/v3alphapreprod/management/accounts'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/analytics/v3alphapreprod/management/accountSummaries'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/entityUserLinks/{linkId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/entityUserLinks'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/clientId:hashClientId'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/customDimensions/{customDimensionId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/customDimensions'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/customMetrics/{customMetricId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/customMetrics'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/experiments/{experimentId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/experiments'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/filters/{filterId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/filters'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals/{goalId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/goals'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/profileFilterLinks/{linkId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/profileFilterLinks'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/entityUserLinks/{linkId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/entityUserLinks'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/remarketingAudiences/{remarketingAudienceId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/remarketingAudiences'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/analytics/v3alphapreprod/management/segments'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/unsampledReports/{unsampledReportId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/profiles/{profileId}/unsampledReports'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
  ...
  export class Resource$Management$Uploads {
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources/{customDataSourceId}/deleteUploadData'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources/{customDataSourceId}/uploads/{uploadId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources/{customDataSourceId}/uploads'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
    ...
    uploadData(
      ...
      const parameters = {
        ...
        mediaUrl: (
          rootUrl +
          '/upload/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/customDataSources/{customDataSourceId}/uploads'
        ).replace(/([^:]\/)\/+/g, '$1'),
        requiredParams: ['accountId', 'webPropertyId', 'customDataSourceId'],
        pathParams: ['accountId', 'customDataSourceId', 'webPropertyId'],
        context: this.context,
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/entityAdWordsLinks/{webPropertyAdWordsLinkId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/entityAdWordsLinks'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/entityUserLinks/{linkId}'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'DELETE',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/management/accounts/{accountId}/webproperties/{webPropertyId}/entityUserLinks'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/metadata/{reportType}/columns'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/provisioning/createAccountTicket'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/provisioning/createAccountTree'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
  ...
  export class Resource$Userdeletion$Userdeletionrequest {
    ...
    /**
     * analytics.userDeletion.userDeletionRequest.get
     * @desc Get user deletion requests.
     * @example
     * // Before running the sample:
     * // - Enable the API at:
     * //   https://console.developers.google.com/apis/api/analytics.googleapis.com
     ...
     *
     *   // Do the magic
     *   const res = await analytics.userDeletion.userDeletionRequest.get({
     *     // Request body metadata
     *     requestBody: {
     *       // request body parameters
     *       // {
     ...
     * });
     *
     * @alias analytics.userDeletion.userDeletionRequest.get
     * @memberOf! ()
     *
     * @param {object} params Parameters for request
     * @param {().UserDeletionRequestKey} params.requestBody Request body data
     * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
     * @param {callback} callback The callback that handles the response.
     * @return {object} Request object
     */
    get(
      params: Params$Resource$Userdeletion$Userdeletionrequest$Get,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    get(
      params?: Params$Resource$Userdeletion$Userdeletionrequest$Get,
    ...
    get(callback: BodyResponseCallback<Schema$UserDeletionRequest>): void;
    get(
      paramsOrCallback?:
        | Params$Resource$Userdeletion$Userdeletionrequest$Get
      ...
      | GaxiosPromise<Readable> {
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Userdeletion$Userdeletionrequest$Get;
      let options = (optionsOrCallback || {}) as MethodOptions;

      if (typeof paramsOrCallback === 'function') {
        callback = paramsOrCallback;
        params = {} as Params$Resource$Userdeletion$Userdeletionrequest$Get;
        options = {};
      }
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/userDeletion/userDeletionRequests:get'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
        ...
        options: Object.assign(
          {
            url: (
              rootUrl +
              '/analytics/v3alphapreprod/userDeletion/userDeletionRequests:upsert'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
  ...
  export interface Params$Resource$Userdeletion$Userdeletionrequest$Get
    extends StandardParameters {
    /**
     * Request body metadata
     */
    requestBody?: Schema$UserDeletionRequestKey;
  }
